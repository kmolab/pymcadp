...
using pyQt5 and the pyeq3 fitting library.
see http://commonproblems.readthedocs.io/en/latest/


If you prefer wxPython, the wxPython version of this code
is at: https://bitbucket.org/zunzuncode/wxPythonFit


Step 1: Install Python 3, pyQt5, scipy and matplotlib

On Debian or Ubuntu Linux, you can use this command:

sudo apt-get install python3-pyqt5 python3-scipy python3-matplotlib
...
Step 3: Run the pyQt5Fit example
...
You are now curve and surface fitting data using pyQt5!



You may also be interested in the django version, which
includes PDF files, surface rotations and "function finding".
It is available at https://bitbucket.org/zunzuncode/zunzunsite3
